...
public class MyItem extends javax.swing.JFrame {
    ...
    private void tampilkan(){
        try{
            ...
            ps = con.prepareStatement("SELECT no_barang AS NoBarang, nama_barang AS NamaBarang, lokasi AS Lokasi, waktu AS Waktu, ciri AS CiriCiri, tipe AS Tipe FROM barang WHERE nim = ?");
    ...
    private void initComponents() {
        ...
        jTable1.setFont(new java.awt.Font("Eras Light ITC", 1, 12)); // NOI18N
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "no_barang", "nama_barang", "lokasi", "waktu", "ciri", "tipe"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MyItem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
