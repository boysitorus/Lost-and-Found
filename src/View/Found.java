...
public class Found extends javax.swing.JFrame {
    ...
    private void tampilkan(){
        try{
            ...
            ps = con.prepareStatement("SELECT no_barang AS NoBarang, nama_barang AS NamaBarang, lokasi AS Lokasi, waktu AS Waktu, ciri AS CiriCiri, nama AS NamaPenemu, nim AS NimPenemu, no_hp AS NoHp FROM barang WHERE tipe = ?");
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nomor", "Nama Barang", "Lokasi Temu", "Waktu Temu", "Ciri Ciri", "Nama Penemu", "NIM Penemu"
            }
        ));
