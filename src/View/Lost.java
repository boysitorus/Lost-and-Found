...
public class Lost extends javax.swing.JFrame {
    ...
    private void tampilkan(){
        try{
            ...
            ps = con.prepareStatement("SELECT no_barang AS NoBarang, nama_barang AS NamaBarang, lokasi AS Lokasi, waktu AS Waktu, ciri AS CiriCiri, nama AS NamaPemilik, nim AS NimPemilik, no_hp AS NoHp FROM barang WHERE tipe = ?");
            ps.setString(1, "Lost");
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nomor", "nama_barang", "lokasi", "waktu", "ciri", "nama", "nim", "no_hp"
            }
        ));
